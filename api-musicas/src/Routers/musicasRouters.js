...
// ============================================================ 
// IMPORTANTE: rotas mais específicas devem vir ANTES das genéricas! // '/categoria/:cat' deve vir antes de '/:id' senão o Express // vai interpretar 'categoria' como um ID. 
